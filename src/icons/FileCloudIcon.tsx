export const FileCloudIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M3 6.66667C3 7.95533 4.00736 9 5.25 9H9.975C11.0934 9 12 8.0598 12 6.9C12 5.7402 11.0833 4.80003 9.96491 4.80003C10.0897 3.36433 8.97992 2 7.5 2C6.20546 2 5.14305 3.03069 5.03419 4.34393C3.89279 4.45657 3 5.45349 3 6.66667Z"
        strokeWidth={strokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
