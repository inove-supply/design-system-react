export const CardExchange01Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M2 15L14 15" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M10 7L22 7" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
