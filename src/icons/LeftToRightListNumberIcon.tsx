export const LeftToRightListNumberIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      <path d="M11 6L21 6" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M11 12L21 12" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M11 18L21 18" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
