export const ClipIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M8.77232 20C8.77232 20 9.62267 11.8193 9.93709 9.47913C10.208 7.46284 6.43388 4.71926 8.76226 3.09378C10.8515 1.63526 13.1483 1.63551 15.2376 3.09392C17.5661 4.71933 13.7927 7.46286 14.0636 9.47913C14.378 11.8193 15.2283 20 15.2283 20"
        strokeWidth={strokeWidth}
        strokeLinejoin="round"
      />
      <path
