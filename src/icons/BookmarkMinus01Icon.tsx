export const BookmarkMinus01Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path d="M3.5 7H10" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M13 5H21" strokeWidth={strokeWidth} strokeLinecap="round" />
    </svg>
  )
}
