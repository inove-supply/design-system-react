export const FolderDetailsReferenceIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M6.65709 15.5694L8.71949 15.5141C9.81727 15.4847 10.3662 15.47 10.6981 15.8019C11.03 16.1338 11.0153 16.6827 10.9859 17.7805L10.9306 19.8429M10.6359 15.8641L5 21.5"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
      ...
      />
      <path
        d="M22 15.5L15 15.5M22 18.5H15M18.5 21.5H15"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
      />
