export const NotificationSnooze03Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M16.016 3H19.6884C20.4611 3 20.8474 3 20.9503 3.24011C21.0532 3.48023 20.7903 3.76827 20.2646 4.34436L16.8469 7.65564C16.3212 8.23173 15.9131 8.51977 16.016 8.75989C16.1189 9 16.6504 9 17.423 9H21"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
        strokeLinejoin="round"
