export const RemoteControlIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M8 15H10" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M8 18H10" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M14 15H16" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M14 18H16" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
