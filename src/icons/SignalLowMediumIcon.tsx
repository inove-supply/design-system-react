export const SignalLowMediumIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      <path d="M5 10L5 19" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M9 13V19" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M13 11L13 19" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M17 19L18 19" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M21 19L22 19" strokeWidth={strokeWidth} strokeLinecap="round" />
    </svg>
  )
}
