export const OnlineLearning02Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M8 7.37354C9.14883 6.50484 10.5209 6 11.9946 6C13.4729 6 14.849 6.50803 16 7.38177M14.1743 9.71791C13.5182 9.33763 12.7779 9.12368 11.9946 9.12368C11.2152 9.12368 10.4784 9.33549 9.82477 9.71219M12 12H12.0064"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
      />
