export const PathfinderMinusBackIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M15 9.00017C14.9973 11.4868 14.9536 12.7833 14.2366 13.6824C14.0732 13.8873 13.8873 14.0732 13.6824 14.2366C12.7833 14.9536 11.4868 14.9973 9.00017 15"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
      />
