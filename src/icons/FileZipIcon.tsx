export const FileZipIcon = ({
  ...
  return (
    ...
    >
      <path
        d="M10 21.998C7.53751 21.9856 6.18354 21.8929 5.20307 21.2021C4.87862 20.9735 4.59058 20.7024 4.3477 20.3971C3.5 19.3313 3.5 17.7966 3.5 14.7272V12.1818C3.5 9.21862 3.5 7.73703 3.96894 6.55372C4.72281 4.6514 6.31714 3.15086 8.33836 2.44133C9.59563 1.99997 11.1698 1.99997 14.3182 1.99997C16.1173 1.99997 17.0168 1.99997 17.7352 2.25217C18.8902 2.65762 19.8012 3.51507 20.232 4.60212C20.5 5.27829 20.5 6.12491 20.5 7.81816V14C20.5 17.4377 20.5 19.3085 19.5571 20.5"
