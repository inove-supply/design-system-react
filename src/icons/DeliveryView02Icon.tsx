export const DeliveryView02Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M3 7.5L3 12.5408C3 16.2928 3 18.1688 4.17157 19.3344C5.23467 20.3921 6.8857 20.49 10 20.4991M21 12.5V7.5"
        strokeWidth={strokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M17 18H17.009" strokeWidth={strokeWidth} />
      <path
        d="M21.772 17.5225C21.924 17.7357 22 17.8422 22 18C22 18.1578 21.924 18.2643 21.772 18.4775C21.089 19.4353 19.3446 21.5 17 21.5C14.6554 21.5 12.911 19.4353 12.228 18.4775C12.076 18.2643 12 18.1578 12 18C12 17.8422 12.076 17.7357 12.228 17.5225C12.911 16.5647 14.6554 14.5 17 14.5C19.3446 14.5 21.089 16.5647 21.772 17.5225Z"
        strokeWidth={strokeWidth}
      />
      <path d="M10 10.5H14" strokeWidth={strokeWidth} strokeLinecap="round" />
    </svg>
  )
}
