export const RightToLeftListNumberIcon = ({
  ...
  return (
    ...
    >
      <path d="M3 6L13 6" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M3 12L13 12" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M3 18L13 18" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
