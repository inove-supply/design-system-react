export const CursorProgress01Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      <path
        d="M15.9637 2.04725C16.4347 1.98425 16.9126 1.98425 17.3836 2.04725M19.9008 3.08814C20.2758 3.37442 20.6254 3.72398 20.9117 4.09896M21.9529 6.61766C22.0157 7.08784 22.0157 7.56479 21.9529 8.03497M13.5964 3.31808C11.445 5.35612 11.5253 8.53789 13.4929 10.5051C15.4826 12.4943 18.7194 12.5591 20.75 10.3326"
