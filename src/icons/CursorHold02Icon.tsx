export const CursorHold02Icon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M17.5 17.95L18.4 16.6M22 17.5C22 19.9853 19.9853 22 17.5 22C15.0147 22 13 19.9853 13 17.5C13 15.0147 15.0147 13 17.5 13C19.9853 13 22 15.0147 22 17.5Z"
        strokeWidth={strokeWidth}
        strokeLinecap="round"
