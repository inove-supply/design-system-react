export const ShoppingBasketSecure02Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={strokeWidth}
      />
      <path d="M4.5 17.5H9.5" strokeWidth={strokeWidth} strokeLinecap="round" />
    </svg>
  )
}
