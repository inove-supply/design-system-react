export const LayoutTable01Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path d="M2.5 9L21.5 9" strokeWidth={strokeWidth} />
      <path d="M16 21.5L16 2.5" strokeWidth={strokeWidth} />
      <path d="M8 21.5L8 2.5" strokeWidth={strokeWidth} />
    </svg>
  )
}
