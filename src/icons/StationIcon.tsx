...
export const StationIcon = ({
  ...
  return (
    // <svg
    //   className={`strokeCurrent text-${color}`}
    //   width={size}
    //   height={size}
    //   viewBox="0 0 24 24"
    //   fill="none"
    ...
    //     strokeLinecap="round"
    //   />
    //   <path d="M7 22H17" strokeWidth={strokeWidth} strokeLinecap="round" />
    // </svg>
    ...
    >
      ...
      <path
        ...
        stroke-linecap="round"
      />
      <path d="M7 22H17" strokeWidth={strokeWidth} stroke-linecap="round" />
    </svg>
  );
};
