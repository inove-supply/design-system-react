export const MoneyNotFound02Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      <path
        d="M13.7418 13.7422C13.2876 14.2094 12.6523 14.4996 11.9492 14.4996C10.5685 14.4996 9.44922 13.3803 9.44922 11.9996C9.44922 11.2966 9.73945 10.6613 10.2066 10.207"
        strokeWidth={strokeWidth}
        strokeLinecap="round"
      />
      <path d="M5 12L6 12" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M18 12L19 12" strokeWidth={strokeWidth} strokeLinecap="round" />
    </svg>
  )
}
