export const SoilMoistureFieldIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M8 9V14" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 14L2 14" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 17L2 17" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 20L2 20" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
