export const CursorInfo02Icon = ({
  ...
  return (
    ...
    >
      <path
        d="M17.5 19.0987C17.5 18.0987 18.4 17.7124 18.4 17C18.4 15.5643 16.375 15.4112 16.375 16.7612M22 17.5C22 19.9853 19.9853 22 17.5 22C15.0147 22 13 19.9853 13 17.5C13 15.0147 15.0147 13 17.5 13C19.9853 13 22 15.0147 22 17.5Z"
