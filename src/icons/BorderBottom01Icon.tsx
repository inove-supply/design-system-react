export const BorderBottom01Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      <path
        d="M2.5 17.5C2.69854 18.5939 3.04969 19.399 3.6708 20.0355C5.09987 21.5 7.39991 21.5 12 21.5C16.6001 21.5 18.9001 21.5 20.3292 20.0355C20.9503 19.399 21.3015 18.5939 21.5 17.5"
      ...
      />
      <path
        d="M2.5 12L4 12M20 12L21.5 12M12 15L12 9M12 4.46875L12 3M9 12L15 12"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
        strokeLinejoin="round"
