export const TaxesIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path d="M4 10V18.5M8 10V18.5" strokeWidth={strokeWidth} />
      <path
      ...
      />
      <circle cx="15.25" cy="15.25" r="0.75" strokeWidth={strokeWidth} />
      <circle cx="20.75" cy="20.75" r="0.75" strokeWidth={strokeWidth} />
    </svg>
  )
}
