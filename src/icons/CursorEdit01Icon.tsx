export const CursorEdit01Icon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M11.5399 20.6835C9.23361 20.8429 6.94858 10.0873 8.51764 8.51798C10.0867 6.94869 20.8431 9.23214 20.6837 11.5384C20.5739 13.0488 18.0175 13.6462 18.0921 14.9885C18.114 15.3817 18.6106 15.74 19.6038 16.4566C20.294 16.9546 20.9978 17.4382 21.6762 17.9521C21.947 18.1572 22.0538 18.5021 21.9744 18.8272C21.5925 20.3888 20.3957 21.5909 18.8277 21.9743C18.5026 22.0539 18.1577 21.9469 17.9527 21.6761C17.4389 20.9976 16.9553 20.2938 16.4574 19.6035C15.7409 18.6101 15.3826 18.1134 14.9895 18.0915C13.6474 18.0169 13.05 20.5737 11.5399 20.6835Z"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
      />
      <path
