export const FolderMusicIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M18.375 19.25C18.375 20.4926 17.3956 21.5 16.1875 21.5C14.9794 21.5 14 20.4926 14 19.25C14 18.0074 14.9794 17 16.1875 17C17.3956 17 18.375 18.0074 18.375 19.25ZM18.375 19.25V12.5C18.6667 12.95 18.9 14.84 21 15.2"
        strokeWidth={strokeWidth}
        strokeLinecap="round"
