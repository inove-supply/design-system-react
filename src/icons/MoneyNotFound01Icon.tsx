export const MoneyNotFound01Icon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M13.7438 13.7422C13.2895 14.2094 12.6542 14.4996 11.9512 14.4996C10.5705 14.4996 9.45117 13.3803 9.45117 11.9996C9.45117 11.2966 9.7414 10.6613 10.2086 10.207"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
      />
