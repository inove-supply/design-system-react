export const WashingtonMonumentIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M9 6H15" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 19L12 13" strokeWidth={strokeWidth} strokeLinecap="round" />
    </svg>
  )
}
