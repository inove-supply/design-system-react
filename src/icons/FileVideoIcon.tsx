export const FileVideoIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M20 12.0142V7.82643C20 6.13079 20 5.28297 19.732 4.60583C19.3012 3.51725 18.3902 2.65858 17.2352 2.25256C16.5168 2 15.6173 2 13.8182 2C10.6698 2 9.09563 2 7.83836 2.44198C5.81714 3.15252 4.22281 4.65518 3.46894 6.56021C3 7.7452 3 9.22888 3 12.1963V14.7453C3 17.819 3 19.3559 3.8477 20.4232C4.09058 20.729 4.37862 21.0005 4.70307 21.2294C5.46329 21.7658 6.44806 21.9421 8 22"
        strokeWidth={strokeWidth}
        style={{ strokeWidth: `${strokeWidth} !important` }}
        strokeLinecap="round"
