export const SoilTemperatureFieldIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M9 9V14" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M13 14L3 14" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M13 17L3 17" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M13 20L3 20" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
