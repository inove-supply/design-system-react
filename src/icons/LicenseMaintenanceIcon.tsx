export const LicenseMaintenanceIcon = ({
  color = 'white',
  strokeWidth = 1.5,
  size = 24
}: {
  ...
  return (
    ...
    >
      <path
        d="M11.5294 22H10.4706C6.47751 22 4.48098 22 3.24049 20.8284C2 19.6569 2 17.7712 2 14L2 10C2 6.22876 2 4.34315 3.24049 3.17157C4.48098 2 6.47752 2 10.4706 2L11.5294 2C15.5225 2 17.519 2 18.7595 3.17157C20 4.34315 20 6.22876 20 10V10.5"
        strokeWidth={strokeWidth}
        strokeLinecap="round"
      />
      <path d="M7 7H15" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M7 12H12" strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
